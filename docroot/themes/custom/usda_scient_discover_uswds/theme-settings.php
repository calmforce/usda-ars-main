...
/**
 * @file
 * Custom theme setting form elements for the USWDS Scientific Discoveries theme.
 */
 ...
 */
function usda_scient_discover_uswds_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
