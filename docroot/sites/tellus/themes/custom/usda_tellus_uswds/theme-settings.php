...
/**
 * @file
 * Custom theme setting form elements for the USWDS tellus theme.
 */
 ...
 */
function usda_tellus_uswds_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
