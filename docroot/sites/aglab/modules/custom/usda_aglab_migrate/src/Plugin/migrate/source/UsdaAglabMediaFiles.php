...
/**
 * Defines UsdaAglabMediaFiles source plugin.
 *
 * This annotation tells Drupal that the name of the MigrateSource plugin
 * implemented by this class is "usda_aglab_media_files". This is the name
 * that the migration configuration references with the source "plugin" key.
 *
 * @MigrateSource(
 *   id = "usda_aglab_media_files",
 *   source_module = "usda_aglab_migrate"
 * )
 */
class UsdaAglabMediaFiles extends SqlBase {
