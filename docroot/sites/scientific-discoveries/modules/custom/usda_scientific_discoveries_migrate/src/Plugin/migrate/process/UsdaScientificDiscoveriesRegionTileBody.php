...
/**
 * Process plugin for Scientific Discoveries Region Tile Body.
 *
 * @MigrateProcessPlugin(
 *   id = "usda_scientific_discoveries_region_tile_body",
 *   handle_multiples = TRUE,
 *   source_module = "usda_scientific_discoveries_migrate"
 * )
 */
class UsdaScientificDiscoveriesRegionTileBody extends ProcessPluginBase {
