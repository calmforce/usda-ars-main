...
/**
 * Defines UsdaScientificDiscoveriesTopics migrate source plugin.
 *
 * This annotation tells Drupal that the name of the MigrateSource plugin
 * implemented by this class is "usda_scientific_discoveries_topics". This is the name
 * that the migration configuration references with the source "plugin" key.
 *
 * @MigrateSource(
 *   id = "usda_scientific_discoveries_topics",
 *   source_module = "usda_scientific_discoveries_migrate"
 * )
 */
class UsdaScientificDiscoveriesTopics extends UsdaArsSource {
  ...
  public function query() {
    ...
    $query->condition('ct.alias', 'topic');
