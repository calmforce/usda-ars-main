...
namespace Drupal\usda_scientific_discoveries_migrate\Controller;
 ...
 *
 * @package Drupal\usda_scientific_discoveries_migrate\Controller
 */
class MssqlTestController extends ControllerBase {
  ...
  public function testConnection() {
    try {
      ...
      $query->condition('prop.propertytypeid', '102');
      $query->range(0, 100);
